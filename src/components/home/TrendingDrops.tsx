    ...
    <section id="shop" className="py-32 relative overflow-hidden bg-white">
        ...
        <div className="flex flex-col md:flex-row items-end justify-between gap-12">
          ...
          <div className="flex items-center gap-8 pb-4">
            ...
            <motion.button 
              ...
              whileTap={{ scale: 0.95 }}
              className="group flex items-center gap-4 bg-gray-900 text-white px-8 py-4 rounded-2xl transition-all text-[10px] uppercase tracking-[0.3em] font-black hover:bg-violet-600 shadow-xl"
            >
              View All
      ...
      >
        ...
        <motion.div 
          ...
          viewport={{ once: true }}
          className="min-w-[300px] md:min-w-[400px] snap-center bg-gray-50 p-12 flex flex-col justify-center border border-gray-100 rounded-[2.5rem]"
        >
      ...
      <div className="max-w-[1400px] mx-auto px-6 md:px-16">
        <div className="h-[2px] w-full bg-gray-50 rounded-full relative overflow-hidden">
          <motion.div 
            ...
            className="absolute top-0 left-0 w-1/3 h-full bg-violet-200/50"
          />
        </div>
      </div>
    </section>
